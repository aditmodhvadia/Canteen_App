                ...
                orderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (dataSnapshot.child(itemCategory).child(itemName).child(getString(R.string.status)).getValue().toString().equals(getString(R.string.ready))
                            ...
                            Toast.makeText(OrderActivity.this, getString(R.string.already_rated), Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(OrderActivity.this, getString(R.string.rate_after_ready), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void updateRating(final float rating, String itemName, String itemCategory) {
        ...
        foodItems.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(OrderActivity.this, getString(R.string.rating_saved), Toast.LENGTH_SHORT).show();
            }
